        ...
        recalc = function () {
         ...
         /*   docEl.style.fontSize = 100 * (clientWidth / 320) + 'px';*/
           ...
           /* $('.container-fluid').css({'height':518*H+'px','background-size':320*W+'px'});*/
            ...
            $('.red_init_main .desc').css({'margin-top': -7*W+'px','font-size': 17*W+'px'});
            $('.red_init_main .jianli_desc').css({'word-spacing': 15*W+'px','margin-top': 17*W+'px','font-size': 14*W+'px'});
            $('.red_init_main .use_fa').css({'margin-top': -8*W+'px','font-size': 15*W+'px','letter-spacing': 1*W+'px'});
