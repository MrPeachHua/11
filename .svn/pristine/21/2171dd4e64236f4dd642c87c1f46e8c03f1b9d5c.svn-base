...
<form action="<%=basePath%>products/parking/specialCar/save.html"  name="form1" onsubmit="return validator(this)" method="post" >
<table class=editTable cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
    ...
    <tr>
     <td><div align="center"><font color="#39d5b8">*</font>小区名称：</div></td>
		...
		<td colspan="3" >
			<input type="text" class="selectList"    maxlength="20"   valid="required"  errmsg="车牌号不能为空!"
    ...
    <td><div align="center">车主姓名：</div></td>
		...
		<td colspan="3" >
			<input type="text"  class="selectList"   maxlength="40"
