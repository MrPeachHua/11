...
//	var customerName = $("#customerName").val();
	...
	window.location="<%=basePath%>products/order/excelExportWithCarNumber.html?orderId="+orderId+"&carNumber="+carNumber+"&orderType="+orderType+"&orderStatus="+orderStatus+"&orderStatus="+orderStatus+"&customerPhone="+customerPhone+"&form_beginTime="+form_beginTime+"&form_endTime="+form_endTime+"&parkingName="+parkingName+"&payType="+payType;
}
</script>
  </head>
  ...
  <body>
  	...
  	<form  action="<%=basePath%>products/order/listWithCarNumber.html" method="post">
	        ...
	        <td>
	        	<table width="100%" border="0" cellspacing="0" cellpadding="0" height="60">
			        ...
			        <td class="STYLE4" align="center">&nbsp;&nbsp;订单类型：
						...
						<select id="orderType" class="btn_tb" name = "orderType" style="margin-left: 0px" >
							<option value=""> </option>
							<option value="13">月租</option>
							<option value="14">产权</option>
							<%--<c:forEach items="${orderType }" var="orderType">--%>
								<%--<c:if test="${orderType.dictValue eq '13' || orderType.dictValue eq '14'}">--%>
					...
					<td class="STYLE4">&nbsp;&nbsp;订单ID：&nbsp;&nbsp;&nbsp;
			        	<input type="text"  name="orderId" id="orderId" value='${page.params["orderId"] }'  class="btn_tb"/>
							 ...
							 <td class="STYLE4" colspan="2">&nbsp;&nbsp;支付类型：&nbsp;<select id="payType" name = "payType" style="width: 120px">
			       ...
			       <input type="text"  name="customerName" id="customerName" value='${page.params["customer_nickname"] }' style="width: 120px"/>
					</td>  -->
      ...
      <%--  <td width="8" background="<%=imagePath%>tab_12.gif">&nbsp;</td>--%>
        <td>
          ...
          <tr  height="50" style="background-color:#ecf6ff">
			...
			<td style="width: 5%"><div align="center"><span class="STYLE1">开始时间 </span></div></td>
			<td style="width: 5%"><div align="center"><span class="STYLE1">结束时间 </span></div></td>
		  </tr>
		  <c:choose>		
          ...
          <%--  <td style="width:  5%"><div align="center"><span class="STYLE1" --%>
					<%--<c:if test="${row.orderStatus eq 10}"> style="color:#ff0000" </c:if>>
           ...
           <%-- </span></div></td>--%>
			...
			<td style="width:  7%"><div align="center"><span class="STYLE1">${row.carNumber}</span></div></td>
			<td style="width:  8%"><div align="center"><span class="STYLE1">${row.customer_mobile}</span></div></td>
			...
			<td style="width:  8%"><div align="center" ><span class="STYLE1"><fmt:formatDate  value="${row.beginTime}" type="both" pattern="yyyy-MM-dd"/> </span></div></td>
			<td style="width:  8%"><div align="center" ><span class="STYLE1"><fmt:formatDate  value="${row.endTime}" type="both" pattern="yyyy-MM-dd"/> </span></div></td>
		  </tr>
	      </c:forEach>
		  </c:when>
          <c:otherwise>
