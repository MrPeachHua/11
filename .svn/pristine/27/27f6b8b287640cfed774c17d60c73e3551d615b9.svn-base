...
public class ExportEquityExcel {
	/*************************************************************************** 
	  ...
	  */  
	 //导出优惠券
	 public  final static String exportEquityExcel(String fileName,String[] Title, List<Propertyparkinginfo> monthlyList,HttpServletResponse response) {  
	...
	// 设定输出文件头        
	   ...
	   for(Object obj:monthlyList){  
	       ...
	       for(Field v:fields){  
	           ...
	           if(j==7&&va.equals(1)){
	        	   va = "黑";
	           }else if(j==7&&va.equals(2)){
	        	   va ="白";
	           }else if(j==7&&va.equals(3)){
	        	   va ="其他";
	           } 
	           if(j==9&&va.equals("0")){
	        	   va="放行";
	           ...
	           if(j==10&&va.equals("0")){
	        	   va="有效";
	           }else if(j==10&&va.equals("1")){
	        	   va="无效";
	           }  
	           if(j==14&&va!=null&&!va.equals("")){
	        	   va = DateUtil.date2str((Date)va, DateUtil.DATE_FORMAT);
	           }
	           if(j==15&&va!=null&&!va.equals("")){
	        	   va = DateUtil.date2str((Date)va, DateUtil.DATE_FORMAT);
	           }
	           if(j==16&&va!=null&&!va.equals("")){
	        	   va = DateUtil.date2str((Date)va, DateUtil.DATE_FORMAT);
	           }
	           if(j==17&&va!=null&&!va.equals("")){
	        	   va = DateUtil.date2str((Date)va, DateUtil.DATE_FORMAT);
	           }
			   if(j==18&&va.equals("0")){
				   va="否";
			   }else if(j==18&&va.equals("1")){
				   va="是";
			   }
			   if (j==19&&"0".equals(va)){
				   va="无效";
			   }else if (j==19 && "1".equals(va)){
				   va="有效";
			   }
