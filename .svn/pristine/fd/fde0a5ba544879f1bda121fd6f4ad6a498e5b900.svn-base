...
<form action="<%=basePath%>products/redeemRule/save.html" method="post">
                                ...
                                <tr>
                                    ...
                                    <td bgcolor="#FFFFFF">
                                        <select name="type" onchange="type_change(this)">
                                            <option value="1">新注册用户使用兑换码获取的优惠券</option>
                                            <option value="2">老用户兑换码被兑换一定次数后可领取的优惠券</option>
                                        </select>
                                    </td>
                                    ...
                                    <td bgcolor="#FFFFFF" rowspan="2">
                                        <input type="text" name="redeemCount" disabled="disabled"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
