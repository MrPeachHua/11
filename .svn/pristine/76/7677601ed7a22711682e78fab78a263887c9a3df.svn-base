...
<form action="<%=basePath%>products/price/save.html" method="post"name="form2" onsubmit="return checkForm('form2');">
  <table class=editTable cellSpacing=1 cellPadding=0 width="100%" align=center border=0>
    <tr class=editHeaderTr>
      <td class=editHeaderTd colSpan=7>  请输入详细信息</td>
    </tr>
    <tr>
      <td width="19%" bgcolor="#FFFDF0"><div align="center">车场名称：</div></td>
      <td colspan="3" bgcolor="#FFFFFF">
        <input type="text" value="${param.villageName}"   maxlength="20"  style=" width: 165px" required
               id="villageName" name="villageName" onclick="parkingPop()" >
        <input type="hidden" value="${param.parkingId}"
    ...
    <tr>
      ...
      <td colspan="3" bgcolor="#FFFFFF"><input id = "price" value="${param.price}" type="text" required   style="width: 138px"  name="price" >
        &nbsp;</td>
      <td width="19%" bgcolor="#FFFDF0"><div align="center">选择属于哪一天：</div></td>
      <td colspan="3" bgcolor="#FFFFFF">
        <input  type="radio"   <c:if test="${fn:contains(packagePrice.week1, '周一') || packagePrice.week1==null}">checked="checked"</c:if>   style="width: 40px" value="周一"  name="week1" >周一
