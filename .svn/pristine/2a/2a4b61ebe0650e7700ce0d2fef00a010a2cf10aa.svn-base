...
public class ExportParkingStatusExcel {
	/*************************************************************************** 
	  ...
	  */  
	 //导出优惠券
	 public  final static String exportParkingStatusExcel(String fileName,String[] Title, List<ParkingStatus> pkList,HttpServletResponse response) {
	...
	// 设定输出文件头        
	   ...
	   for(Object obj:pkList){
	       ...
	       int j=0;  
	       for(Field v:fields){  
	    	   if(v.getName().equals("serialVersionUID")||v.getName().equals("id")) continue;
			   if(v.getName().equals("serialVersionUID")||v.getName().equals("parkingId")) continue;
	           ...
	           if(j==1&&va.equals("0")){
	        	   va = "空";
	           }else if(j==1&&va.equals("1")){
	        	   va ="紧张";
	           }else if(j==1&&va.equals("2")){
	        	   va ="满";
	           } 
