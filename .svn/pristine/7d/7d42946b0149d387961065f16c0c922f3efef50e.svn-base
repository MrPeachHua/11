package com.boxiang.framework.base; 
...
public class Constants { 
	...
	public static final String LOGIN_USER = "shareUser";
	...
	public static final String SMS_KEY = "boxiang2015";
	
	public static final String PROFILE_ID_PRE ="pre";
	public static final String PROFILE_ID_PROD ="prod";
}
