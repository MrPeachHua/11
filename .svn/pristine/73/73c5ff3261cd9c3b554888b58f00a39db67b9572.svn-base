...
//alert(cs.length);
    ...
    <script type="text/javascript">
        ...
        function add() {
            window.location = "<%=basePath%>products/parking/monthly/add.html";
        }
        function excelExport() {
            var p_queryValue = $("#p_queryValue").val();
            var p_queryType = $("#p_queryType").val();
            var isUsed = $("#isUsed").val();
            window.location = "<%=basePath%>products/parking/monthly/excelExport.html?queryValue=" + p_queryValue + "&queryType=" + p_queryType + "&isUsed=" + isUsed;
        }
        ...
        function uploadMonth() {
            ...
            if (filepath == null || filepath == '') {
                ...
                $.ajaxFileUpload({
                    type: "POST",
                    url: "<%=basePath%>products/parking/monthly/uploadExcel.html",
                    data: {},
                    secureuri: false,
                    fileElementId: "file",
                    dataType: 'text',
...
<div id="bg"></div>
<!-- 弹出层的结束 -->
<form action="<%=basePath%>products/parking/monthly/list.html" method="post">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr height="60">
            <td class="STYLE4" align="center">请输入查询内容：<input class="btn_tb" type="text" id="p_queryValue"
                                                             name="p_queryValue" value="${page.params["queryValue"] }"/>
            </td>
            ...
            <td class="STYLE4">
                <security:authorize access="hasAnyRole('AUTH_ADD_0017')"><input class="btn" type="button" value="添加"
                                                                                onclick="add()"/></security:authorize>
            </td>
            <td class="STYLE4"><security:authorize access="hasAnyRole('AUTH_IMP_0020')"><input class="btn" type="button"
                                                                                               onclick="uploadExport()"
                                                                                               value="导入"/></security:authorize>
            </td>
            <td class="STYLE4"><security:authorize access="hasAnyRole('AUTH_EXP_0021')"><input class="btn" type="button"
                                                                                               onclick="excelExport()"
                                                                                               value="导出"/></security:authorize>
            </td>
        </tr>
    </table>
    <td>
                ...
                <td>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" onmouseover="changeto()"
                        ...
                        <tr height="50" style="background-color:#ecf6ff">
                            ...
                            <td style="width:5%">
                                <div align="center"><span class="STYLE1">小区名称</span></div>
                            </td>
                            <td style="width:5%">
                                <div align="center"><span class="STYLE1">车牌号</span></div>
                            </td>
                            <td style="width:5%">
                                <div align="center"><span class="STYLE1">车主姓名</span></div>
                            </td>
                            <td style="width:5%">
                                <div align="center"><span class="STYLE1">车主联系电话</span></div>
                            </td>
                            <td style="width:5%">
                                <div align="center"><span class="STYLE1">月租单价</span></div>
                            </td>
                            <td style="width:5%">
                                <div align="center"><span class="STYLE1">是否违规</span></div>
                            </td>
                            <td style="width:5%">
                                <div align="center"><span class="STYLE1">当月有效情况</span></div>
                            </td>
                            <td style="width:5%">
                                <div align="center"><span class="STYLE1">有效开始时间</span></div>
                            </td>
                            <td style="width:5%">
                                <div align="center"><span class="STYLE1">有效结束时间</span></div>
                            </td>
                            <td style="width:5%">
                                <div align="center"><span class="STYLE1">记录状态</span></div>
                            </td>
                            <security:authorize access="hasAnyRole('AUTH_DEL_0018','AUTH_EDIT_0019','AUTH_EDIT_0118')">
                        ...
                        <c:choose>
                            <c:when test="${fn:length(page.resultList)>0}">
                                <c:forEach items="${page.resultList}" var="row" varStatus="status">
                                    <tr class="underline" height="50" style="background-color: #FFF;" <c:if
                                            test="${row.isExpired eq 0}"> style="color:red;font-weight: bold"</c:if>>
                                        <td style="width:2%">
                                            <div align="center"><span class="STYLE1">${status.count}</span></div>
                                        </td>
                                        <td style="width:5%">
                                            <div align="center"><span class="STYLE1">${row.villageName}</span></div>
                                        </td>
                                        <td style="width:5%">
                                            <div align="center"><span class="STYLE1">${row.carNumber}</span></div>
                                        </td>
                                        <td style="width:5%">
                                            <div align="center"><span class="STYLE1">${row.owner}</span></div>
                                        </td>
                                        <td style="width:5%">
                                            <div align="center"><span class="STYLE1">${row.phone}</span></div>
                                        </td>
                                        <td style="width:5%">
                                            <div align="center"><span class="STYLE1">${row.monthlyRentalPrice}</span>
                                            </div>
                                        </td>
                                        <td style="width:5%">
                                            <div align="center"><span class="STYLE1"><c:if
                                                    test="${row.iillegalFlg eq 0}">放行</c:if><c:if
                                                    test="${row.iillegalFlg eq 1}">不允许进入</c:if></span></div>
                                        </td>
                                        <td style="width:5%">
                                            <div align="center"><span class="STYLE1"><c:if
                                                    test="${row.validityFlg eq 0}">有效</c:if><c:if
                                                    test="${row.validityFlg eq 1}">无效</c:if></span></div>
                                        </td>
                                        <td style="width:5%">
                                            <div align="center"><span class="STYLE1"><fmt:formatDate
                                                    value="${row.effect_begin_time}" type="both"
                                                    pattern="yyyy-MM-dd"/></span></div>
                                        </td>
                                        <td style="width:5%">
                                            <div align="center"><span class="STYLE1"><fmt:formatDate
                                                    value="${row.effect_end_time}" type="both"
                                                    pattern="yyyy-MM-dd"/> </span></div>
                                        </td>
                                        <td style="width:5%">
				  ...
				  <c:if test="${row.isUsed eq 1}">
                      有效
                                        ...
                                        <security:authorize
                                                access="hasAnyRole('AUTH_DEL_0018','AUTH_EDIT_0019','AUTH_EDIT_0118')">
                                            <td style="width: 5%">
                                                <div align="center"><span class="STYLE4">
            	  <security:authorize access="hasAnyRole('AUTH_EDIT_0019')">
                      <c:if test="${row.isUsed eq 1}">
                          <a href="<%=basePath %>products/parking/monthly/toedit.html?villageId=${row.villageId}&carNumber=${row.carNumber } "><span
                                  class="icon_bg blue"><img class="icon" title="编辑"
                                                            src="<%=basePath%>/images/new/compile.png"></span></a>
                      </c:if>
                  </security:authorize>
       			<security:authorize access="hasAnyRole('AUTH_EDIT_0118')">
                    <c:if test="${row.isUsed eq 1}">
                        <a onclick="addFree('${row.villageId}','${row.carNumber}','<fmt:formatDate
                                value="${row.effect_begin_time}" type="both" pattern="yyyy-MM-dd"/>','<fmt:formatDate
                                value="${row.effect_end_time}" type="both"
                                pattern="yyyy-MM"/>','${row.monthlyRentalPrice}','${row.villageName}','<fmt:formatDate
                                value="${row.effect_end_time}" type="both" pattern="yyyy-MM-dd"/>')"
                           style="cursor: hand">
                            <span class="icon_bg green"><img title="续费" class="icon"
                                                             src="<%=basePath%>/images/new/need_fee.png" style="cursor: pointer;"></span></a>
                    </c:if>
                </security:authorize>
       			<security:authorize access="hasAnyRole('AUTH_DEL_0018')">
                    <a class="bg_recover"
                       href="javascript:if (confirm('你确定？')) location.href='<%=basePath %>products/parking/monthly/del.html?villageId=${row.villageId}&carNumber=${row.carNumber}&isUsed=${row.isUsed}';">
                        <c:if test="${row.isUsed eq 1}">
                            <span class="icon_bg red">
                                <img class="icon" title="作废" src="<%=basePath%>/images/new/delete.png">
                            </span>
                        </c:if>
                        <c:if test="${row.isUsed eq 0}">
                            <span class="icon_bg_recover caolv">
...
<div class="content1" id="addCoupon">
    <div>
        ...
        <div style="margin-top: 15px; margin-left: 30px;">
            <form method="post" action="<%=basePath%>products/parking/monthly/addFree.html" id="formActions">
                <table>
                    <tr>
                        <td>
                        ...
                        <td>
                            <select class="select_cc" name="orderType" id="orderType" readonly>
                                <option value="13" selected>月租</option>
                                <%--<option value="14">产权</option>--%>
                            </select>
                        </td>
                        <td>
                            <div style="float: right">车牌号：</div>
                        </td>
                        <td>
                            <input type="text" readonly id="carNumber" class="select_cc" name="carNumber">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" class="select_cc villageName" readonly  name="villageName">
                        </td>
                        <td>
                            <div>收款平台：</div>
                        </td>
                        <td>
                            <select class="select_cc" name="payType" id="payType" readonly>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="select_cc" readonly name="price" id="price">
                        </td>
                        <td>
                            <div>有效期开始时间：</div>
                        </td>
                        <td>
                            ...
                            <input type="text"  class="select_cc" valid="required" errmsg="有效开始时间不能为空!"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="select_cc" valid="required" errmsg="有效结束时间不能为空!"
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="select_cc" name="orderStatus" id="orderStatus" readonly>
                        ...
                        <td>
                            <input type="text" class="select_cc" id="amountDiscount" readonly value="0" name="amountDiscount">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <select class="select_cc" name="invoiceStatus" id="invoiceStatus">
                        ...
                        <td>
                            <input type="text" id="payTime" class="select_cc" valid="required" errmsg="支付时间不能为空!"
                                   value="<%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()) %>"
                                   onclick="WdatePicker({minDate: '%y-%M-%d',el:payTime,dateFmt:'yyyy-MM-dd HH:mm:ss'})"
                                   name="payTime"/>
                        </td>
                    </tr>
                    <tr>
