...
public class ApiV2Util {
	...
	public static final String postPath = "http://139.196.24.16/p_share_web";
	public static RestTemplate before(){
		//String resourceUrl ="http://p-share.cn/p_share_web"+postPath;
		//String resourceUrl = "http://139.196.24.16/p_share_web"+postPath;
