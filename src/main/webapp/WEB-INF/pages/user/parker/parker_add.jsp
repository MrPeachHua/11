...
/* td { text-overflow: ellipsis; white-space: nowrap; overflow: hidden;width: 200px; } */
  ...
  function onParkerType(){
	...
	<div class="content" id="parkingForm">
		...
		<form action="<%=basePath%>users/parkersave.html"  name="form1" onsubmit="return validator(this)"   method="post"
			...
			<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
				...
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text" name="parkerName"  maxlength="10" style="width: 145px" valid="required"  errmsg="员工姓名不能为空!" >
						&nbsp;
					</td>
					<td width="13%" bgcolor="#FFFDF0">
						<div align="center">
					...
					<td colspan="3" bgcolor="#FFFFFF">
						...
						onclick="parkingPop()" style="width: 145px" id="parkingCode"/>
				...
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text" name="parkerAge" style="width: 145px"   maxlength="2"  valid="required|isNumber"  errmsg="年龄不能为空!|请输入正确的年龄!" >						&nbsp;
					</td>
					<td bgcolor="#FFFDF0">
						<div align="center">
							角色：
					...
					<td colspan="3" bgcolor="#FFFFFF">
						...
						&nbsp;
						<select id="parkerLevel" name="parkerLevel">
						  <option value ="A" selected="selected">代泊员主管</option>
						  <option value ="B">高级代泊员</option>
						  <option value="C">初级代泊员</option>
						</select>
					</td>
				</tr>
				<!-- end -->
				...
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input name="parkerCardid" type="text" style="width: 145px"  maxlength="18">
						&nbsp;
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text" name="parkerDriverAge"  maxlength="10" style="width: 145px" value="0"  errmsg="员工姓名不能为空!" >
						&nbsp;
					</td>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text" value="${parker.parkerMobile}" name="parkerMobile"  maxlength="11" style="width: 145px"   errmsg="员工姓名不能为空!" >
					</td>
				</tr>
				<tr>
					<td bgcolor="#FFFDF0">
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input id = "parkerPassword" type="password"  maxlength="20"  check_str="密码" style="width: 145px" name="parkerPassword" >
						&nbsp;
					</td>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						...
						<input type="radio" checked="checked" name="isDisplay" value="0" />否
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
					<share:imageUpload imageLabelName="身份头像" imagePathId="imagePath" savePath="product/"  />
					<input type="hidden"  id="imagePath" name="parkerHead"  />
					&nbsp;
					</td>
