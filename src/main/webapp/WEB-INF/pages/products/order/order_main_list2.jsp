...
function excelExport(){
	...
	window.location="<%=basePath%>products/order/excelReport2.html?customerPhone="+customerPhone+"&carNumber="+carNumber+"&orderType="+orderType+"&parkingId="+parkingId+"&inputDate="+inputDate+"&region="+region+"&onlineType="+onlineType;
}
</script>
  </head>
  ...
  <body>
  	...
  	<form  action="<%=basePath%>products/order/list2.html" method="post">
	        ...
	        <td>
			  ...
			  <%--      <td class="STYLE4" align="center">&nbsp;&nbsp;订单类型：
			        ...
			        <td class="STYLE4">&nbsp;&nbsp;订单状态：
			        	...
			        	&lt;%&ndash;<input type="hidden" id="select2" value="${page.params['orderStatus'] }"/>&ndash;%&gt;
					</td>
					...
					--%>
 					<tr>
						...
						<td class="STYLE4">
							...
							<input type="hidden" name="inputDate" id="inputDate" value="${inputDate}"/>
							<input type="hidden" name="onlineType" id="onlineType" value="${onlineType}"/>
						</td>
  ...
  <tr>
    ...
    <table class="table_content" border="0" cellspacing="0" cellpadding="0">
     ...
     <%--   <td width="8" background="<%=imagePath%>tab_15.gif">&nbsp;</td>--%>
		...
		<tr>
			<td s >
				&nbsp;&nbsp;&nbsp;<span style="font-weight: 700;">单页缴费合计：</span><span class="STYLE1" style="font-size: 16px"> 临停：<fmt:formatNumber type="number" maxFractionDigits="0" value="${temporary/100}" />元&nbsp;&nbsp; 月租：<fmt:formatNumber type="number" maxFractionDigits="0" value="${monthly/100}" />元&nbsp;&nbsp; 产权：<fmt:formatNumber type="number" maxFractionDigits="0" value="${equity/100}" />元</span>
				...
				&nbsp;&nbsp;&nbsp;<span style="font-weight: 700;">全部缴费合计：</span><span class="STYLE1"  style="font-size: 16px"> 临停：<fmt:formatNumber type="number" maxFractionDigits="0" value="${temporary1/100}"/>元&nbsp;&nbsp; 月租：<fmt:formatNumber type="number" maxFractionDigits="0" value="${monthly1/100}" />元&nbsp;&nbsp; 产权：<fmt:formatNumber type="number" maxFractionDigits="0" value="${equity1/100}" />元</span>
