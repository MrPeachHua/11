...
<div id="bg"></div>
  ...
  <body>
<form action="<%=basePath%>products/carlife/srvbilling/update.html"  name="form1" onsubmit="return validator(this)" method="post" >
<table class=editTable cellSpacing=1 cellPadding=0 width="100%" align=center border=0>
	<tr class=editHeaderTr>
		<td class=editHeaderTd colSpan=7>  请输入车场服务费信息<span style="color: red;"><s:fielderror /></span></td>
        <td><input type="hidden" name="id" value="${carlifeSrvBilling.id}"   /></td>
        <td><input type="hidden" name="isUsed" value="${carlifeSrvBilling.isUsed}"   /></td>
        <td><input type="hidden" name="createor" value="${carlifeSrvBilling.createor}"   /></td>
        <td><input type="hidden" name="createDate" value="${carlifeSrvBilling.createDate}"   /></td>
	</tr>  
    <tr>
	  	<td bgcolor="#FFFDF0"><div align="center">车场名称：</div></td>
		<td colspan="3" bgcolor="#FFFFFF">
			<input type="text"    style=" width: 165px"  readonly="readonly"
			id="parkingCode" value="${carlifeSrvBilling.parkingName}" onclick="parkingPop()">
			<input type="hidden" name = "parkingId" id="parkingId" value="${carlifeSrvBilling.parkingId}"/>
		</td>
	  	<td bgcolor="#FFFDF0"><div align="center">服务名称：</div></td>
		<td colspan="3" bgcolor="#FFFFFF"><input type="text" id="srvinfoId"  readonly="readonly" value="${carlifeSrvBilling.srv_name}"  style=" width: 165px"   onclick="SrvinfoPop()"></td>
		<input type="hidden" name = "srvId" id="srvId" value="${carlifeSrvBilling.srvId}"/>
    </tr>
    <tr>
	  	<td bgcolor="#FFFDF0"><div align="center">车型：</div></td>
		<td colspan="3" bgcolor="#FFFFFF">
			<select style=" width: 165px" name="carType">
				<c:forEach var="dictionary" items="${dictionary }">
							<c:choose>
								<c:when test="${dictionary.dictValue eq carlifeSrvBilling.carType}">
	  	...
	  	<td bgcolor="#FFFDF0"><div align="center">服务费：</div></td>
				<td colspan="3" bgcolor="#FFFFFF"><input type="text" valid="required"
					errmsg="服务费不能为空!"
					style=" width: 165px" name="srvFee"
					value="${carlifeSrvBilling.srvFee}"
					onkeyup="value=value.replace(/[^\d]/g,'') "
					onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))">
				</td>
			</tr>
			<tr>
				<td bgcolor="#FFFDF0"><div align="center">服务价格：</div>
				</td>
				<td colspan="3" bgcolor="#FFFFFF"><input type="text" valid="required"
					errmsg="服务价格不能为空!"
					name="srvPrice" value="${carlifeSrvBilling.srvPrice}"
					style=" width: 165px" onkeyup="value=value.replace(/[^\d]/g,'') "
					onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))">
				</td>
				<td bgcolor="#FFFDF0"><div align="center">现在价格：</div></td>
				<td colspan="3" bgcolor="#FFFFFF"><input type="text" value="${carlifeSrvBilling.nowPrice}"
