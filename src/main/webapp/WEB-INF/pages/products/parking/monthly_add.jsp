...
<html>
	<head>
		...
		<link href="<%=basePath%>css/file.css" ype=text/css rel=stylesheet>
...
//source.style.backgroundColor=originalcolor
		...
		<form action="<%=basePath%>products/parking/monthly/save.html" name="form1" onsubmit="return validator(this)" method="post">
			<table class=editTable cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
				...
				<tr>
					<td>
						<div>
							<font color="#39d5b8">*</font>小区名称：</div>
					</td>
					<td colspan="3">
						<input type="text" class="selectList" maxlength="20" valid="required" errmsg="小区名称不能为空!" id="villageName" name="villageName" onclick="parkingPop()">
						<input type="hidden" valid="required" errmsg="车场名称不能为空!" name="villageId" id="parkingId" />
					</td>
					<td>
						<div>
							<font color="#39d5b8">*</font>车牌号：</div>
					</td>
					<td colspan="3">
						<input type="text" class="selectList" maxlength="20" valid="required" errmsg="车牌号不能为空!" id="carNumber" name="carNumber">
					</td>
				</tr>
				<tr>
					<td>
					...
					<td colspan="3">
						<input id="owner" class="selectList" name="owner" />
					</td>
					<td>
						<div>身份信息：</div>
					</td>
					<td colspan="3">
						<input id="certificate" class="selectList" name="certificate" />
					</td>
				</tr>
				<tr>
					<td>
					...
					<td colspan="3">
						<input type="text" class="selectList" name="address" id="address">
					</td>
					...
					<td colspan="3">
						<input type="text" class="selectList" id="phone" name="phone">
					</td>
				</tr>
				<tr>
					<td>
			 ...
			 <option value="3">其他</option>
					...
					<td>
						<div>
							<font color="#39d5b8">*</font>月租单价：</div>
					</td>
					<td colspan="3">
						<input type="text" class="selectList" id="monthlyRentalPrice" valid="required" errmsg="月租单价不能为空!" name="monthlyRentalPrice">
					</td>
				</tr>
				<tr>
					<td>
					...
					<td colspan="3">
						<select name="iillegalFlg" class="selectList" id="iillegalFlg">
					...
					<td colspan="3">
						<select name="validityFlg" class="selectList" id="validityFlg">
				...
				<tr>
					...
					<td colspan="3">
						<input type="text" class="selectList" id="effect_begin_time" readonly="readonly" value="${date}" onclick="WdatePicker({el:effect_begin_time,dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'effect_end_time\')}'})" name="effect_begin_time1" />
					</td>
					<td>
						<div>结束时间：</div>
					</td>
					<td colspan="3">
						<input type="text" class="selectList" id="effect_end_time" readonly="readonly" value="${date}" onclick="WdatePicker({el:effect_end_time,dateFmt:'yyyy-MM',minDate:'#F{$dp.$D(\'effect_begin_time\')}'})" name="effect_end_time1" />
					</td>
				</tr>
				<tr>
					<td>
					...
					<td colspan="3">
						<input type="text" id="max_date" class="selectList" readonly="readonly" onclick="WdatePicker({el:max_date,dateFmt:'yyyy-MM'})" name="max_date1" />
					</td>
					<td>
						<div>是否开通线上支付：</div>
					</td>
					<td colspan="3">
						<select name="onlinePayment" class="selectList" id="onlinePayment">
				...
				<tr>
					...
					<td colspan="3">
						<input type="text" id="makeUp" class="selectList" maxlength="40" value="" name="makeUp">
					</td>
					<td>
						<div>所属系统：</div>
					</td>
						...
						<c:if test="${model eq 2}">
							<select  name="module" id="module" class="selectList">
								...
								<c:forEach var="dictionary" items="${dictionaryList}">
									<option value="${dictionary.dictValue}">
											${dictionary.dictName}
									</option>
								</c:forEach>
							</select>
